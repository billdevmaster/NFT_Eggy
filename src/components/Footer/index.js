        ...
        <footer className="bg-secondary">
            <div className="container mx-auto">
                <div className="flex items-center justify-center mb-20">
                    <button className="bg-transparent rounded-full w-60 text-center p-2 border-4 border-white hover:border-opacity-70 font-bold text-white text-2xl mx-5">
                        FAQS
                    </button>
                    <button className="bg-transparent rounded-full w-60 text-center p-2 border-4 border-white hover:border-opacity-70 font-bold text-white text-2xl mx-5">
                        Join Discord
                ...
                <div className="flex items-center justify-between">
                    <p className="text-white font-bold text-lg">© 2021 Studio Eggy Ltd</p>
